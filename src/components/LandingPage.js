  ...
  return (
    <div>
      <section className="landing-page comp">
        ...
        <p>In my front-end development, I have a focus on ReactJS, HTML, CSS (including some CSS preprocessors), and JavaScript. I'm familiar with RESTful APIs and unit/snapshot testing using both Jest and React Testing Library. Though I'm mostly focused on expanding and mastering my React knowledge these days, I still make time to learn and practice Angular.</p>
        <p>You can view my resume with the link below or contact me using this site. Thank you for visiting and have a great day!</p>
        <a className="view-resume" href="https://drive.google.com/file/d/1Gx5DfP51YrByVycpzt7wIyJuO2TYiqZa/view?usp=sharing" target="_blank">Resume</a>
      </section>
    </div>
  );
}
